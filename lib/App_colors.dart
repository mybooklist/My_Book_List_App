...
class AppColors {
  static const Color primary = Color(0xFF414C9E);    // Azul principal
  static const Color secondary = Color(0xFFA974A0);  // Roxo secundário
  static const Color accent = Color(0xFFCF7486);     // Rosa destaque
